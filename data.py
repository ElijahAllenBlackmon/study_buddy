...
CH2_Q = [
    ...
    input(" Used to configure console, SSH, Telnet, or AUX access:\n"),
    input("Used to configure a switch port or router network interface:\n"),
    ...
    input("Lines enable remote access using Telnet or SSH to the device:\n"),
    ...
    input("This is stored in Random Access Memory (RAM). It reflects the current configuration. Modifying a running configuration affects the operation of a Cisco device immediately. RAM is volatile memory. It loses all of its content when the device is powered off or restarted:\n"),
