...
CH7_Q = [
    input("LLC:\n"),
    input("MAC:\n"),
    input("Is implemented in hardware and is responsible for data encapsulation and media access control. It provides data link layer addressing and is integrated with various physical layer technologies:\n"),
    input("Places information in the frame that identifies which network layer protocol is being used for the frame. This information allows multiple Layer 3 protocols, such as IPv4 and IPv6, to use the same network interface and media:\n"),
    input("IEEE 802.2\n"),
    input("Ethernet IEEE 802.3:\n"),
    input("WLAN IEEE:\n"),
    input("Responsible for data encapsulation and accessing the media:\n"),
    input("The Ethernet frame includes both a source and destination MAC address to deliver the Ethernet frame from Ethernet NIC to Ethernet NIC on the same LAN:\n"),
    input("The Ethernet frame includes a frame check sequence (FCS) trailer used for error detection:\n"),
    input("Duplex communications with Ethernet switches do not require access control through CSMA/CD:\n"),
    input("Minimum Ethernet frame size:\n"),
    input("Any frame less than 64 bytes in length:\n"),
    input("Expected maximum frame size:\n"),
    input("Frames with more than 1500 bytes of data:\n"),
    input("Which part of an Ethernet Frame uses a pad to increase the frame field to at least 64 bytes?\n"),
    input("Which part of an Ethernet frame detects errors in the frame?\n"),
    input("Which part of an Ethernet Frame describes the higher-layer protocol that is encapsulated?\n"),
    input("Which part of an Ethernet Frame notifies the receiver to get ready for a new frame?\n"),
    input("Which data link sublayer controls the network interface through software drivers?\n"),
    input("OUI:\n"),
    input("\n"),
    input("\n"),
    input("\n"),
